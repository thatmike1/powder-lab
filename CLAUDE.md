...
Rough order of interestingness, not commitment. Pick whatever's fun.
...
- **🏷️ Polish.** Add a `LICENSE` file (README claims MIT but none exists yet); bump the GitHub Actions to Node 24 before the June 2026 deprecation.
